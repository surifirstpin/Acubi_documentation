...
**For Instance** : Select **Percentage** checkbox in Pie chart which displays the quantity sum percentage of each month. 
...
**Image 6**
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0NDg4MzI3NCw1MTc2MTczLC00Mzg4Mz
