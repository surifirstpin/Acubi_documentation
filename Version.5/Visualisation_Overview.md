...
**For Instance** :  Create a report to fetch Order details and query **Stationcode, Whenmade_Month and order_value_sum.** Apply **filter** to **whenmade_month** to a limit the data  to January, February and March. Now 
Consider a pie Chart in visualization section. ( Pie chart supports maximum 20 division)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzM0MzM4MTIsMTIzMDQ3MDIzNCwtMT
...
ODMxNTk0LDEyOTM5NzY2MjcsMTgwMjQ3MzQ0NSwyNjY4ODg2Nz
YsNTk3MzE5MTQwLDIxMzE5OTA5ODAsMTExMTE4MTEzNl19
-->