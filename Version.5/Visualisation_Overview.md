...
**For Instance** : In this example we will consider a pie chart, For which create a report to fetch Order details.  In this example we will query  **Stationcode, Whenmade_Month and order_value_sum.** Apply filter order_value_sum to a limit of less than or equal to 200000. ( Pie chart supports maximum 20 division)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NDEwOTYyMzYsMjY2ODg4Njc2LDU5Nz
MxOTE0MCwyMTMxOTkwOTgwLDExMTExODExMzZdfQ==
-->