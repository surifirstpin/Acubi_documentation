...
**For Example :**  Apply Pivot to **whenmade_month**Apply subtraction for Order Value_Sum and derive the expression in calculated column as follow ;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4MDk4NTQ2NywtMTk3Nzc5NzIzNSwtMT
